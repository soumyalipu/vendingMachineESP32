...
<html lang="en">
<head>
  <?php headContent("EntityUser_detailsDelete");?>
</head>
			...
			<form method="POST">
				...
				<div class="w3-container w3-card-2" style="margin-top:-12px">
					<div class="form-group">
						...
						<a href="EntityUser_detailsList.php" class="w3-btn w3-small w3-round w3-blue" >Back</a>
					</div>
				</div>
			</form>
		</div>
...
<?php
	...
	if($user_detailsModel -> DeleteUser_detailsById($_GET["id"]))
	{
		echo '<script>alert("User_details record deleted successfully.");window.location="EntityUser_detailsList.php";</script>';
	}
	else
	{
		echo '<script>alert("Unable to delete User_details.");window.location="EntityUser_detailsList.php";</script>';
	}
	}
?>
<!-- End: Delete Data-->
